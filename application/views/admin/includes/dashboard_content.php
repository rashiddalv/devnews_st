        ...
        <div class="col-lg-8 mb-4 order-0">
            <div class="card">
                <div class="d-flex align-items-end row">
                    <div class="col-sm-7">
                        <div class="card-body">
                            <h5 class="card-title text-primary">Təbrik edirik <?php echo $admin['a_name']; ?> bəy! 🎉</h5>
                            <p class="mb-4">
                            Bu gün <span class="fw-bold">72%</span> daha çox satış etdiniz. Profilinizdə yeni nişanınızı yoxlayın.
                            </p>

                            <a href="javascript:;" class="btn btn-sm btn-outline-primary">Nişanlara bax</a>
                        </div>
                    </div>

          ...
          <div class="card-body">
            ...
            <div class="app-brand justify-content-center">
              <a href="index.html" class="app-brand-link gap-2">
                ...
                <span class="app-brand-text demo text-body fw-bolder">DEVNews</span>
              </a>
            </div>
            <!-- /Logo -->
            <h4 class="mb-2">DEVNews Admin'ə xoş gəlmisiniz!</h4>
            <p class="mb-4">Zəhmət olmasa hesabınıza daxil olun.</p>

            <form id="formAuthentication" class="mb-3" action="<?php echo base_url('login_act'); ?>" method="POST">
              <div class="mb-3">
                <label for="email" class="form-label">E-poçt və ya istifadəçi adı</label>
                <input type="text" class="form-control" id="email" name="email" placeholder="E-poçt və ya istifadəçi adınızı daxil edin" autofocus />
              </div>
              <div class="mb-3 form-password-toggle">
                <div class="d-flex justify-content-between">
                  <label class="form-label" for="password">Parol</label>
                  <a href="<?php echo base_url('pass_forgot') ?>">
              ...
              <div class="mb-3">
                <div class="form-check">
                  <input class="form-check-input" type="checkbox" id="remember-me" name="autologin" value="1"/>
